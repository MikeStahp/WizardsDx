...
public class WizardsEffects {
        ...
        public static Effects.Entry frostSlowness = add(new Effects.Entry(
                        new Identifier(WizardsMod.ID + ":frost_slowness"),
                        "Slowness",
        ...
        public static Effects.Entry arcaneCharge = add(new Effects.Entry(
                        new Identifier(WizardsMod.ID + ":arcane_charge"),
                        "Arcane Charge",
