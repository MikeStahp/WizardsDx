...
public class FrostSpells {
    ...
    public static WizardSpells.Entry frost_shard = WizardSpells.add(frost_shard());

    private static WizardSpells.Entry frost_shard() {
    ...
    public static WizardSpells.Entry frostbolt = WizardSpells.add(frostbolt());

    private static WizardSpells.Entry frostbolt() {
    ...
    public static WizardSpells.Entry frost_nova = WizardSpells.add(frost_nova());

    private static WizardSpells.Entry frost_nova() {
    ...
    public static WizardSpells.Entry frost_shield = WizardSpells.add(frost_shield());

    private static WizardSpells.Entry frost_shield() {
    ...
    public static WizardSpells.Entry frost_blizzard = WizardSpells.add(frost_blizzard());

    private static WizardSpells.Entry frost_blizzard() {
