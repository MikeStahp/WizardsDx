...
public class FireSpells {
    ...
    public static WizardSpells.Entry fire_scorch = WizardSpells.add(fire_scorch());

    private static WizardSpells.Entry fire_scorch() {
    ...
    public static WizardSpells.Entry fireball = WizardSpells.add(fireball());

    private static WizardSpells.Entry fireball() {
    ...
    public static WizardSpells.Entry fire_blast = WizardSpells.add(fire_blast());

    private static WizardSpells.Entry fire_blast() {
    ...
    public static WizardSpells.Entry fire_breath = WizardSpells.add(fire_breath());

    private static WizardSpells.Entry fire_breath() {
    ...
    public static WizardSpells.Entry fire_meteor = WizardSpells.add(fire_meteor());

    private static WizardSpells.Entry fire_meteor() {
    ...
    public static WizardSpells.Entry fire_wall = WizardSpells.add(fire_wall());

    private static WizardSpells.Entry fire_wall() {
        ...
        return new WizardSpells.Entry(id, spell, name, description, null);
    }
