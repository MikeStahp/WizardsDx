...
public class WizardVillagers {
    ...
    public static VillagerProfession registerProfession(String name, RegistryKey<PointOfInterestType> workStation) {
        ...
        return Registry.register(Registries.VILLAGER_PROFESSION, id, new VillagerProfession(
                id.toString(),
                (entry) -> {
    ...
    //
    // public Offer(int level, ItemStack input, ItemStack output, int maxUses, int
    // experience, float priceMultiplier) {
    // this.level = level;
    // this.input = input;
    // this.output = output;
    ...
    // }
    //
    // public static Offer buy(int level, ItemStack item, int price, int maxUses,
    // int experience, float priceMultiplier) {
    // return new Offer(level, item, new ItemStack(Items.EMERALD, price), maxUses,
    // experience, priceMultiplier);
    // }
    //
    // public static Offer sell(int level, ItemStack item, int price, int maxUses,
    // int experience, float priceMultiplier) {
    // return new Offer(level, new ItemStack(Items.EMERALD, price), item, maxUses,
    // experience, priceMultiplier);
    // }
    // }
    ...
    public static void register() {
        ...
        // Offer.sell(1, new ItemStack(RuneItems.get(RuneItems.RuneType.ARCANE), 8), 2,
        // 128, 1, 0.01f),
        // Offer.sell(1, new ItemStack(RuneItems.get(RuneItems.RuneType.FIRE), 8), 2,
        // 128, 1, 0.01f),
        // Offer.sell(1, new ItemStack(RuneItems.get(RuneItems.RuneType.FROST), 8), 2,
        // 128, 1, 0.01f),
        ...
        // Offer.sell(3, Armors.wizardRobeSet.head.getDefaultStack(), 15, 12, 13,
        // 0.05f),
        // Offer.sell(3, Armors.wizardRobeSet.feet.getDefaultStack(), 15, 12, 13,
        // 0.05f),
        // Offer.sell(4, Armors.wizardRobeSet.chest.getDefaultStack(), 20, 12, 15,
        // 0.05f),
